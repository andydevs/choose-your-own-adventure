...
/* harmony import */ var _story__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./story */ "./app/story.js");
/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ui */ "./app/ui.js");
/**
...
function selectStoryPart(option) {
  ...
  console.log('You picked: ' + option.text); // Find story part

  console.log('Getting part with id: ' + option.id);
  var part = _story__WEBPACK_IMPORTED_MODULE_1__["default"].findPart(option.id);
  console.log(part); // Set part

  _ui__WEBPACK_IMPORTED_MODULE_2__["updateStory"](option, part);
  console.groupEnd();
} // Let's start the freaking story!


document.title = _story__WEBPACK_IMPORTED_MODULE_1__["default"].title;
_ui__WEBPACK_IMPORTED_MODULE_2__["storyId$"].subscribe(selectStoryPart);
_ui__WEBPACK_IMPORTED_MODULE_2__["initialize"](_story__WEBPACK_IMPORTED_MODULE_1__["default"].findPart('$'));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _story_yaml__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./story.yaml */ "./app/story.yaml");
var _story_yaml__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./story.yaml */ "./app/story.yaml", 1);
...
/* harmony default export */ __webpack_exports__["default"] = (_objectSpread(_objectSpread({}, _story_yaml__WEBPACK_IMPORTED_MODULE_0__), {}, {
  /**
   * Find story part given id
   * 
   * @param {string} id ID of the story port
   */
  findPart: function findPart(id) {
...
/*!*******************!*\
  !*** ./app/ui.js ***!
  \*******************/
/*! exports provided: storyId$, updateStory, initialize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "storyId$", function() { return storyId$; });
...
var textArea = document.getElementById('cyoa-text');
var controlsArea = document.getElementById('cyoa-controls');
/**
...
function createEndingArea(ending) {
  // Create ending area
  var endingArea = document.createElement('div');
  endingArea.classList.add('ending'); // Create ending text

  var endingText = document.createElement('p');
  endingText.classList.add('ending-text');
  endingText.innerHTML = ending;
  endingArea.appendChild(endingText); // Create play again option

  var button = createOptionButton({
    id: '$',
    text: 'Play Again'
  });
  endingArea.appendChild(button); // Return ending area

  return endingArea;
} // storyId subject


var storyId$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__["Subject"]();
/**
...
function updateStory(option, part) {
  var partDom = document.createElement('div');
  partDom.classList.add('part');

  if (option.id !== '$') {
    var partOptionDom = document.createElement('p');
    partOptionDom.classList.add('part-option');
    var partOptionTextDom = document.createElement('span');
  ...
  var partTextDom = document.createElement('p');
  partTextDom.classList.add('part-text');
  partTextDom.innerHTML = part.text;
  partDom.appendChild(partTextDom); // Set part

  textArea.appendChild(partDom);
  partDom.scrollIntoView(false); // Set controls
...
function initialize(part) {
  ...
  textArea.innerHTML = "<div class='part'><p class='part-text'>".concat(part.text, "</p></div>");
  controlsArea.innerHTML = '';
...
// Module
exports.push([module.i, "/**\n * Exactly what it says on the tin\n * \n * Author:  Anshul Kharbanda\n * Created: 10 - 26 - 2020\n */\n* {\n  font-family: Verdana, Geneva, Tahoma, sans-serif;\n}\n\n#cyoa-app {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  max-height: 100%;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  padding: 16pt;\n}\n\n.container {\n  height: 100%;\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n\n.spacer {\n  flex: 0 0 auto;\n  height: 16pt;\n}\n\n#cyoa-text {\n  flex: 1;\n  overflow-y: auto;\n}\n\n#cyoa-controls {\n  flex: 0;\n}\n\n.part-option {\n  text-align: right;\n}\n\n/**\n * Exactly what it says on the tin\n * \n * Author:  Anshul Kharbanda\n * Created: 10 - 26 - 2020\n */\n.ending-text {\n  text-align: right;\n  font-weight: bold;\n}\n.ending-text:before {\n  content: \"Ending: \";\n  font-weight: normal;\n}\n\n.option, .part-option-text {\n  display: block;\n  margin: 8pt 0pt;\n  margin-left: auto;\n  padding: 4pt 8pt;\n  border-top-left-radius: 8pt;\n  border-bottom-left-radius: 8pt;\n  border: 1px solid;\n  border-color: transparent;\n  transition: border-color 0.25s ease-in-out;\n  background-color: #eee;\n}\n.option:hover, .part-option-text:hover {\n  border-color: #d5d5d5;\n}\n\n.part-option-text {\n  display: inline-block;\n  background-color: #eee !important;\n}\n.part-option-text:hover {\n  border-color: #d5d5d5 !important;\n}\n\n.option:nth-of-type(1), .part-option-text:nth-of-type(1) {\n  background-color: aqua;\n}\n.option:nth-of-type(1):hover, .part-option-text:nth-of-type(1):hover {\n  border-color: #00cccc;\n}\n\n.option:nth-of-type(2), .part-option-text:nth-of-type(2) {\n  background-color: lime;\n}\n.option:nth-of-type(2):hover, .part-option-text:nth-of-type(2):hover {\n  border-color: #00cc00;\n}\n\n.option:nth-of-type(3), .part-option-text:nth-of-type(3) {\n  background-color: #ffdd00;\n}\n.option:nth-of-type(3):hover, .part-option-text:nth-of-type(3):hover {\n  border-color: #ccb100;\n}\n\n.option:nth-of-type(4), .part-option-text:nth-of-type(4) {\n  background-color: lightsalmon;\n}\n.option:nth-of-type(4):hover, .part-option-text:nth-of-type(4):hover {\n  border-color: #ff7c47;\n}\n\n.option:nth-of-type(5), .part-option-text:nth-of-type(5) {\n  background-color: violet;\n}\n.option:nth-of-type(5):hover, .part-option-text:nth-of-type(5):hover {\n  border-color: #e855e8;\n}", ""]);
// Exports
